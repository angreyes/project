 ...
 * @author wjforero
 */
public class ListBrasier implements ICommand {
...
// 1. Get the request parameters
        ...
        // 2. Do something with the data. usually you:
            ...
            request.setAttribute("brasierList", products);
            // 3. Finally, returns the command result
            result.setResult("listBrasier");
        } catch (Exception e) {
            Logger.getLogger(ListBrasier.class.getName()).log(Level.WARNING, null, e);
