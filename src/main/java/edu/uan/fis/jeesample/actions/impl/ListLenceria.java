 ...
 * @author wjforero
 */
public class ListLenceria implements ICommand {
...
// 1. Get the request parameters
        ...
        // 2. Do something with the data. usually you:
            ...
            request.setAttribute("lenceriaList", products);
            // 3. Finally, returns the command result
            result.setResult("listLenceria");
        } catch (Exception e) {
            Logger.getLogger(ListLenceria.class.getName()).log(Level.WARNING, null, e);
