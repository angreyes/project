 ...
 * @author wjforero
 */
public class ProductDesc implements ICommand {
...
// 1. Get the request parameters
        ...
        // 2. Do something with the data. usually you:
            ...
            request.setAttribute("product", products.get(5));
            // 3. Finally, returns the command result
            result.setResult("productDescription");
        } catch (Exception e) {
            Logger.getLogger(ProductDesc.class.getName()).log(Level.WARNING, null, e);
